...
namespace MyWebFoundation.Framework.Encrypt
{
    /// <summary>
    /// 可逆对称加密  密钥长度8
    /// </summary>
    ...
    {
        //8位长度
        private static string KEY = "MyWebFoundation";
        private static byte[] key = ASCIIEncoding.ASCII.GetBytes(KEY.Substring(0, 15));
        private static byte[] iv = ASCIIEncoding.ASCII.GetBytes(KEY.Insert(0, "w").Substring(0, 15));
